...
online version: https://docs.microsoft.com/powershell/module/az.synapse/update-azsynapseprivatelinkhub
schema: 2.0.0
---

# Update-AzSynapsePrivateLinkHub
...
```
Update-AzSynapsePrivateLinkHub -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzSynapsePrivateLinkHub -InputObject <ISynapseIdentity> [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
