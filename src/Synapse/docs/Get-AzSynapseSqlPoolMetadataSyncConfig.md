...
online version: https://docs.microsoft.com/powershell/module/az.synapse/get-azsynapsesqlpoolmetadatasyncconfig
schema: 2.0.0
---

# Get-AzSynapseSqlPoolMetadataSyncConfig
...
### Get (Default)
```
Get-AzSynapseSqlPoolMetadataSyncConfig -ResourceGroupName <String> -SqlPoolName <String>
...
### GetViaIdentity
```
Get-AzSynapseSqlPoolMetadataSyncConfig -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>]
...
### Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.IMetadataSyncConfig
