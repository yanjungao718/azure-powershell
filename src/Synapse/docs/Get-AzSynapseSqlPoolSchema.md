...
online version: https://docs.microsoft.com/powershell/module/az.synapse/get-azsynapsesqlpoolschema
schema: 2.0.0
---

# Get-AzSynapseSqlPoolSchema
...
### List (Default)
```
Get-AzSynapseSqlPoolSchema -ResourceGroupName <String> -SqlPoolName <String> -WorkspaceName <String>
 [-SubscriptionId <String[]>] [-Filter <String>] [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### Get
```
Get-AzSynapseSqlPoolSchema -ResourceGroupName <String> -SchemaName <String> -SqlPoolName <String>
...
### GetViaIdentity
```
Get-AzSynapseSqlPoolSchema -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
