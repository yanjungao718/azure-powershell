...
### Resume (Default)
```
Resume-AzSynapseSqlPool -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
...
### ResumeViaIdentity
```
Resume-AzSynapseSqlPool -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
