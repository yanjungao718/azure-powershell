...
online version: https://docs.microsoft.com/powershell/module/az.synapse/disable-azsynapseintegrationruntimeinteractivequery
schema: 2.0.0
---

# Disable-AzSynapseIntegrationRuntimeInteractiveQuery
...
### Disable (Default)
```
Disable-AzSynapseIntegrationRuntimeInteractiveQuery -IntegrationRuntimeName <String>
...
### DisableViaIdentity
```
Disable-AzSynapseIntegrationRuntimeInteractiveQuery -InputObject <ISynapseIdentity>
