...
online version: https://docs.microsoft.com/powershell/module/az.synapse/new-azsynapseintegrationruntimeauthkey
schema: 2.0.0
---

# New-AzSynapseIntegrationRuntimeAuthKey
...
```
New-AzSynapseIntegrationRuntimeAuthKey -IntegrationRuntimeName <String> -ResourceGroupName <String>
 -WorkspaceName <String> [-SubscriptionId <String>] [-KeyName <IntegrationRuntimeAuthKeyName>]
...
```
New-AzSynapseIntegrationRuntimeAuthKey -IntegrationRuntimeName <String> -ResourceGroupName <String>
 -WorkspaceName <String> -RegenerateKeyParameter <IIntegrationRuntimeRegenerateKeyParameters>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RegenerateViaIdentity
```
New-AzSynapseIntegrationRuntimeAuthKey -InputObject <ISynapseIdentity>
 -RegenerateKeyParameter <IIntegrationRuntimeRegenerateKeyParameters> [-DefaultProfile <PSObject>] [-Confirm]
...
```
New-AzSynapseIntegrationRuntimeAuthKey -InputObject <ISynapseIdentity>
 [-KeyName <IntegrationRuntimeAuthKeyName>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Synapse.Support.IntegrationRuntimeAuthKeyName
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.IIntegrationRuntimeRegenerateKeyParameters
...
### Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.IIntegrationRuntimeRegenerateKeyParameters

### Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.ISynapseIdentity

## OUTPUTS

### Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.IIntegrationRuntimeAuthKeys
...
REGENERATEKEYPARAMETER <IIntegrationRuntimeRegenerateKeyParameters>: Parameters to regenerate the authentication key.
  - `[KeyName <IntegrationRuntimeAuthKeyName?>]`: The name of the authentication key to regenerate.
