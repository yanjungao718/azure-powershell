...
online version: https://docs.microsoft.com/powershell/module/az.synapse/sync-azsynapseintegrationruntimecredentials
schema: 2.0.0
---

# Sync-AzSynapseIntegrationRuntimeCredentials
...
### Sync (Default)
```
Sync-AzSynapseIntegrationRuntimeCredentials -IntegrationRuntimeName <String> -ResourceGroupName <String>
...
### SyncViaIdentity
```
Sync-AzSynapseIntegrationRuntimeCredentials -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>]
