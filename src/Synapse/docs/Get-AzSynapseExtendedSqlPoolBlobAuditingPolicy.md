...
online version: https://docs.microsoft.com/powershell/module/az.synapse/get-azsynapseextendedsqlpoolblobauditingpolicy
schema: 2.0.0
---

# Get-AzSynapseExtendedSqlPoolBlobAuditingPolicy
...
### Get (Default)
```
Get-AzSynapseExtendedSqlPoolBlobAuditingPolicy -ResourceGroupName <String> -SqlPoolName <String>
...
### GetViaIdentity
```
Get-AzSynapseExtendedSqlPoolBlobAuditingPolicy -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>]
