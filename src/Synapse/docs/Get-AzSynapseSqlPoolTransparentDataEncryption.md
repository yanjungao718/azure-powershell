...
### Get (Default)
```
Get-AzSynapseSqlPoolTransparentDataEncryption -ResourceGroupName <String> -SqlPoolName <String>
 -WorkspaceName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzSynapseSqlPoolTransparentDataEncryption -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.ITransparentDataEncryption
