...
### Get (Default)
```
Get-AzSynapseIntegrationRuntimeNode -IntegrationRuntimeName <String> -NodeName <String>
...
### GetViaIdentity
```
Get-AzSynapseIntegrationRuntimeNode -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
