...
online version: https://docs.microsoft.com/powershell/module/az.synapse/remove-azsynapsesqlpoolworkloadgroup
schema: 2.0.0
---

# Remove-AzSynapseSqlPoolWorkloadGroup
...
### Delete (Default)
```
Remove-AzSynapseSqlPoolWorkloadGroup -ResourceGroupName <String> -SqlPoolName <String>
...
### DeleteViaIdentity
```
Remove-AzSynapseSqlPoolWorkloadGroup -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>] [-AsJob]
