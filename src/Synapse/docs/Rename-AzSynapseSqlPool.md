...
online version: https://docs.microsoft.com/powershell/module/az.synapse/rename-azsynapsesqlpool
schema: 2.0.0
---

# Rename-AzSynapseSqlPool
...
```
Rename-AzSynapseSqlPool -Name <String> -ResourceGroupName <String> -WorkspaceName <String> -Id <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Rename
```
Rename-AzSynapseSqlPool -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
 -Parameter <IResourceMoveDefinition> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RenameViaIdentity
```
Rename-AzSynapseSqlPool -InputObject <ISynapseIdentity> -Parameter <IResourceMoveDefinition>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RenameViaIdentityExpanded
```
Rename-AzSynapseSqlPool -InputObject <ISynapseIdentity> -Id <String> [-DefaultProfile <PSObject>] [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.IResourceMoveDefinition
...
### Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.IResourceMoveDefinition
...
PARAMETER <IResourceMoveDefinition>: Contains the information necessary to perform a resource move (rename).
