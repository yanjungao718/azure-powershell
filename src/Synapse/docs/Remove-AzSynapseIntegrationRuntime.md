...
### Delete (Default)
```
Remove-AzSynapseIntegrationRuntime -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
...
### DeleteViaIdentity
```
Remove-AzSynapseIntegrationRuntime -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>] [-AsJob]
