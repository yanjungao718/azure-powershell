...
online version: https://docs.microsoft.com/powershell/module/az.synapse/get-azsynapseintegrationruntimestatus
schema: 2.0.0
---

# Get-AzSynapseIntegrationRuntimeStatus
...
### Get (Default)
```
Get-AzSynapseIntegrationRuntimeStatus -IntegrationRuntimeName <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzSynapseIntegrationRuntimeStatus -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>] [-Confirm]
