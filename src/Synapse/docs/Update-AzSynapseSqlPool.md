...
```
Update-AzSynapseSqlPool -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
 [-SubscriptionId <String>] [-Collation <String>] [-CreateMode <String>] [-CreationDate <DateTime>]
 [-Location <String>] [-MaxSizeByte <Int64>] [-ProvisioningState <String>] [-RecoverableDatabaseId <String>]
 [-RestorePointInTime <DateTime>] [-SkuCapacity <Int32>] [-SkuName <String>] [-SkuTier <String>]
 [-SourceDatabaseId <String>] [-Status <String>] [-StorageAccountType <StorageAccountType>] [-Tag <Hashtable>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzSynapseSqlPool -InputObject <ISynapseIdentity> [-Collation <String>] [-CreateMode <String>]
 [-CreationDate <DateTime>] [-Location <String>] [-MaxSizeByte <Int64>] [-ProvisioningState <String>]
 [-RecoverableDatabaseId <String>] [-RestorePointInTime <DateTime>] [-SkuCapacity <Int32>] [-SkuName <String>]
 [-SkuTier <String>] [-SourceDatabaseId <String>] [-Status <String>]
 [-StorageAccountType <StorageAccountType>] [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-PassThru]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Synapse.Support.StorageAccountType
Parameter Sets: (All)
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.ISqlPool
