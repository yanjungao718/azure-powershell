...
online version: https://docs.microsoft.com/powershell/module/az.synapse/get-azsynapsesqlpooldatawarehouseuseractivity
schema: 2.0.0
---

# Get-AzSynapseSqlPoolDataWarehouseUserActivity
...
### Get (Default)
```
Get-AzSynapseSqlPoolDataWarehouseUserActivity -ResourceGroupName <String> -SqlPoolName <String>
...
### GetViaIdentity
```
Get-AzSynapseSqlPoolDataWarehouseUserActivity -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>]
...
### Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.IDataWarehouseUserActivities
