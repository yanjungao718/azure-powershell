...
online version: https://docs.microsoft.com/powershell/module/az.synapse/remove-azsynapsesqlpoolsensitivitylabel
schema: 2.0.0
---

# Remove-AzSynapseSqlPoolSensitivityLabel
...
### Delete (Default)
```
Remove-AzSynapseSqlPoolSensitivityLabel -ColumnName <String> -ResourceGroupName <String> -SchemaName <String>
...
### DeleteViaIdentity
```
Remove-AzSynapseSqlPoolSensitivityLabel -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>]
