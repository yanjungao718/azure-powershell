...
### Delete (Default)
```
Remove-AzSynapseSqlPoolRestorePoint -ResourceGroupName <String> -RestorePointName <String>
...
### DeleteViaIdentity
```
Remove-AzSynapseSqlPoolRestorePoint -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>] [-PassThru]
