...
online version: https://docs.microsoft.com/powershell/module/az.synapse/get-azsynapseintegrationruntimenodeipaddress
schema: 2.0.0
---

# Get-AzSynapseIntegrationRuntimeNodeIPAddress
...
### Get (Default)
```
Get-AzSynapseIntegrationRuntimeNodeIPAddress -IntegrationRuntimeName <String> -NodeName <String>
...
### GetViaIdentity
```
Get-AzSynapseIntegrationRuntimeNodeIPAddress -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
