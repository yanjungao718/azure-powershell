...
online version: https://docs.microsoft.com/powershell/module/az.synapse/update-azsynapsesqlpoolsensitivitylabel
schema: 2.0.0
---

# Update-AzSynapseSqlPoolSensitivityLabel
...
```
Update-AzSynapseSqlPoolSensitivityLabel -ResourceGroupName <String> -SqlPoolName <String>
 -WorkspaceName <String> [-SubscriptionId <String>] [-Operation <ISensitivityLabelUpdate[]>]
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzSynapseSqlPoolSensitivityLabel -InputObject <ISynapseIdentity>
 [-Operation <ISensitivityLabelUpdate[]>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.ISensitivityLabelUpdate[]
Parameter Sets: (All)
Aliases:
...
OPERATION <ISensitivityLabelUpdate[]>: .
