...
online version: https://docs.microsoft.com/powershell/module/az.synapse/enable-azsynapsesqlpoolsensitivitylabelrecommendation
schema: 2.0.0
---

# Enable-AzSynapseSqlPoolSensitivityLabelRecommendation
...
### Enable (Default)
```
Enable-AzSynapseSqlPoolSensitivityLabelRecommendation -ColumnName <String> -ResourceGroupName <String>
...
### EnableViaIdentity
```
Enable-AzSynapseSqlPoolSensitivityLabelRecommendation -InputObject <ISynapseIdentity>
