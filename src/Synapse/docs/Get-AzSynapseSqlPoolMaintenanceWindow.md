...
online version: https://docs.microsoft.com/powershell/module/az.synapse/get-azsynapsesqlpoolmaintenancewindow
schema: 2.0.0
---

# Get-AzSynapseSqlPoolMaintenanceWindow
...
### Get (Default)
```
Get-AzSynapseSqlPoolMaintenanceWindow -ResourceGroupName <String> -SqlPoolName <String>
 -WorkspaceName <String> -MaintenanceWindowName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzSynapseSqlPoolMaintenanceWindow -InputObject <ISynapseIdentity> -MaintenanceWindowName <String>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.IMaintenanceWindows
