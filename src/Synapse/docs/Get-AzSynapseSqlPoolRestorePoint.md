...
### List (Default)
```
Get-AzSynapseSqlPoolRestorePoint -ResourceGroupName <String> -SqlPoolName <String> -WorkspaceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzSynapseSqlPoolRestorePoint -ResourceGroupName <String> -RestorePointName <String> -SqlPoolName <String>
...
### GetViaIdentity
```
Get-AzSynapseSqlPoolRestorePoint -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.IRestorePoint
