...
online version: https://docs.microsoft.com/powershell/module/az.synapse/remove-azsynapsebigdatapool
schema: 2.0.0
---

# Remove-AzSynapseBigDataPool
...
### Delete (Default)
```
Remove-AzSynapseBigDataPool -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
...
### DeleteViaIdentity
```
Remove-AzSynapseBigDataPool -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
