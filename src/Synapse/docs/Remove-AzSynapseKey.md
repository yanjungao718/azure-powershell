...
online version: https://docs.microsoft.com/powershell/module/az.synapse/remove-azsynapsekey
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzSynapseKey -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzSynapseKey -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>] [-PassThru] [-Confirm]
