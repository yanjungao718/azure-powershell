...
online version: https://docs.microsoft.com/powershell/module/az.synapse/remove-azsynapsesqlpoolworkloadclassifier
schema: 2.0.0
---

# Remove-AzSynapseSqlPoolWorkloadClassifier
...
### Delete (Default)
```
Remove-AzSynapseSqlPoolWorkloadClassifier -ResourceGroupName <String> -SqlPoolName <String>
...
### DeleteViaIdentity
```
Remove-AzSynapseSqlPoolWorkloadClassifier -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>]
