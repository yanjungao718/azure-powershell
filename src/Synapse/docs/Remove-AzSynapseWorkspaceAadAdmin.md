...
online version: https://docs.microsoft.com/powershell/module/az.synapse/remove-azsynapseworkspaceaadadmin
schema: 2.0.0
---

# Remove-AzSynapseWorkspaceAadAdmin
...
### Delete (Default)
```
Remove-AzSynapseWorkspaceAadAdmin -ResourceGroupName <String> -WorkspaceName <String>
...
### DeleteViaIdentity
```
Remove-AzSynapseWorkspaceAadAdmin -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>] [-AsJob]
