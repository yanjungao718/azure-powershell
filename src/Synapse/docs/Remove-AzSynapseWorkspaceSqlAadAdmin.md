...
online version: https://docs.microsoft.com/powershell/module/az.synapse/remove-azsynapseworkspacesqlaadadmin
schema: 2.0.0
---

# Remove-AzSynapseWorkspaceSqlAadAdmin
...
### Delete (Default)
```
Remove-AzSynapseWorkspaceSqlAadAdmin -ResourceGroupName <String> -WorkspaceName <String>
...
### DeleteViaIdentity
```
Remove-AzSynapseWorkspaceSqlAadAdmin -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>] [-AsJob]
