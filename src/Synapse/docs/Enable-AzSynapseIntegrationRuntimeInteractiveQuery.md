...
online version: https://docs.microsoft.com/powershell/module/az.synapse/enable-azsynapseintegrationruntimeinteractivequery
schema: 2.0.0
---

# Enable-AzSynapseIntegrationRuntimeInteractiveQuery
...
### Enable (Default)
```
Enable-AzSynapseIntegrationRuntimeInteractiveQuery -IntegrationRuntimeName <String>
...
### EnableViaIdentity
```
Enable-AzSynapseIntegrationRuntimeInteractiveQuery -InputObject <ISynapseIdentity>
