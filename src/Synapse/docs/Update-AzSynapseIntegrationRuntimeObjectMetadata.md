...
online version: https://docs.microsoft.com/powershell/module/az.synapse/update-azsynapseintegrationruntimeobjectmetadata
schema: 2.0.0
---

# Update-AzSynapseIntegrationRuntimeObjectMetadata
...
### Refresh (Default)
```
Update-AzSynapseIntegrationRuntimeObjectMetadata -IntegrationRuntimeName <String> -ResourceGroupName <String>
...
### RefreshViaIdentity
```
Update-AzSynapseIntegrationRuntimeObjectMetadata -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>]
...
### Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.ISsisObjectMetadataStatusResponse
