...
online version: https://docs.microsoft.com/powershell/module/az.synapse/get-azsynapseworkspacesqlaadadmin
schema: 2.0.0
---

# Get-AzSynapseWorkspaceSqlAadAdmin
...
### Get (Default)
```
Get-AzSynapseWorkspaceSqlAadAdmin -ResourceGroupName <String> -WorkspaceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzSynapseWorkspaceSqlAadAdmin -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.IWorkspaceAadAdminInfo
