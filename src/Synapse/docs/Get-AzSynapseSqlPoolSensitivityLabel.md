...
online version: https://docs.microsoft.com/powershell/module/az.synapse/get-azsynapsesqlpoolsensitivitylabel
schema: 2.0.0
---

# Get-AzSynapseSqlPoolSensitivityLabel
...
### Get (Default)
```
Get-AzSynapseSqlPoolSensitivityLabel -ColumnName <String> -ResourceGroupName <String> -SchemaName <String>
 -SensitivityLabelSource <SensitivityLabelSource> -SqlPoolName <String> -TableName <String>
...
### GetViaIdentity
```
Get-AzSynapseSqlPoolSensitivityLabel -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Synapse.Support.SensitivityLabelSource
Parameter Sets: Get
Aliases:
...
### Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.ISensitivityLabel
