...
```
Update-AzSynapseIntegrationRuntimeNode -IntegrationRuntimeName <String> -NodeName <String>
 -ResourceGroupName <String> -WorkspaceName <String> [-SubscriptionId <String>] [-ConcurrentJobsLimit <Int32>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzSynapseIntegrationRuntimeNode -InputObject <ISynapseIdentity> [-ConcurrentJobsLimit <Int32>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Values between 1 and maxConcurrentJobs(inclusive) are allowed.
...
### Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.ISelfHostedIntegrationRuntimeNode
