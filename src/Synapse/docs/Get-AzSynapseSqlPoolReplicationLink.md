...
online version: https://docs.microsoft.com/powershell/module/az.synapse/get-azsynapsesqlpoolreplicationlink
schema: 2.0.0
---

# Get-AzSynapseSqlPoolReplicationLink
...
### List (Default)
```
Get-AzSynapseSqlPoolReplicationLink -ResourceGroupName <String> -SqlPoolName <String> -WorkspaceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzSynapseSqlPoolReplicationLink -LinkId <String> -ResourceGroupName <String> -SqlPoolName <String>
 -WorkspaceName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzSynapseSqlPoolReplicationLink -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.IReplicationLink
