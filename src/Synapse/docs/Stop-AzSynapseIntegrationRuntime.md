...
### Stop (Default)
```
Stop-AzSynapseIntegrationRuntime -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
...
### StopViaIdentity
```
Stop-AzSynapseIntegrationRuntime -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>] [-AsJob]
