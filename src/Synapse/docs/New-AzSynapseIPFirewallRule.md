...
online version: https://docs.microsoft.com/powershell/module/az.synapse/new-azsynapseipfirewallrule
schema: 2.0.0
---

# New-AzSynapseIPFirewallRule
...
```
New-AzSynapseIPFirewallRule -ResourceGroupName <String> -RuleName <String> -WorkspaceName <String>
