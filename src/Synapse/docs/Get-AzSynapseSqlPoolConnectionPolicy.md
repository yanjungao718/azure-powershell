...
online version: https://docs.microsoft.com/powershell/module/az.synapse/get-azsynapsesqlpoolconnectionpolicy
schema: 2.0.0
---

# Get-AzSynapseSqlPoolConnectionPolicy
...
### Get (Default)
```
Get-AzSynapseSqlPoolConnectionPolicy -ResourceGroupName <String> -SqlPoolName <String> -WorkspaceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzSynapseSqlPoolConnectionPolicy -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.ISqlPoolConnectionPolicy
