...
online version: https://docs.microsoft.com/powershell/module/az.synapse/get-azsynapsesqlpoolmaintenancewindowoption
schema: 2.0.0
---

# Get-AzSynapseSqlPoolMaintenanceWindowOption
...
### Get (Default)
```
Get-AzSynapseSqlPoolMaintenanceWindowOption -ResourceGroupName <String> -SqlPoolName <String>
 -WorkspaceName <String> -MaintenanceWindowOptionsName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzSynapseSqlPoolMaintenanceWindowOption -InputObject <ISynapseIdentity>
 -MaintenanceWindowOptionsName <String> [-DefaultProfile <PSObject>] [-PassThru] [<CommonParameters>]
```
...
### Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.IMaintenanceWindowOptions
