...
online version: https://docs.microsoft.com/powershell/module/az.synapse/remove-azsynapseprivatelinkhub
schema: 2.0.0
---

# Remove-AzSynapsePrivateLinkHub
...
### Delete (Default)
```
Remove-AzSynapsePrivateLinkHub -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzSynapsePrivateLinkHub -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
