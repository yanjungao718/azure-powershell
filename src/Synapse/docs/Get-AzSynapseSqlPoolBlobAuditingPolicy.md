...
online version: https://docs.microsoft.com/powershell/module/az.synapse/get-azsynapsesqlpoolblobauditingpolicy
schema: 2.0.0
---

# Get-AzSynapseSqlPoolBlobAuditingPolicy
...
### Get (Default)
```
Get-AzSynapseSqlPoolBlobAuditingPolicy -ResourceGroupName <String> -SqlPoolName <String>
...
### GetViaIdentity
```
Get-AzSynapseSqlPoolBlobAuditingPolicy -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>]
