...
### List (Default)
```
Get-AzSynapseIntegrationRuntime -ResourceGroupName <String> -WorkspaceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzSynapseIntegrationRuntime -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
 [-SubscriptionId <String[]>] [-IfNoneMatch <String>] [-DefaultProfile <PSObject>] [-PassThru]
 [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzSynapseIntegrationRuntime -InputObject <ISynapseIdentity> [-IfNoneMatch <String>]
