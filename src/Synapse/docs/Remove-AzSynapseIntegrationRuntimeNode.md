...
### Delete (Default)
```
Remove-AzSynapseIntegrationRuntimeNode -IntegrationRuntimeName <String> -NodeName <String>
...
### DeleteViaIdentity
```
Remove-AzSynapseIntegrationRuntimeNode -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
