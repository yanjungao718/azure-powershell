...
online version: https://docs.microsoft.com/powershell/module/az.synapse/get-azsynapseintegrationruntimeconnectioninfo
schema: 2.0.0
---

# Get-AzSynapseIntegrationRuntimeConnectionInfo
...
### Get (Default)
```
Get-AzSynapseIntegrationRuntimeConnectionInfo -IntegrationRuntimeName <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzSynapseIntegrationRuntimeConnectionInfo -InputObject <ISynapseIdentity> [-DefaultProfile <PSObject>]
...
### Microsoft.Azure.PowerShell.Cmdlets.Synapse.Models.Api20210301.IIntegrationRuntimeConnectionInfo
