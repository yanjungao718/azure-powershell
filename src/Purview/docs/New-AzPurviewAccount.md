...
```
New-AzPurviewAccount -Name <String> -ResourceGroupName <String> -Location <String> -SkuCapacity <Int32>
 -SkuName <String> [-SubscriptionId <String>] [-IdentityType <String>] [-ManagedResourceGroupName <String>]
