...
.Outputs
Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20201201Preview.IDefaultAccountPayload
.Link
https://docs.microsoft.com/powershell/module/az.purview/get-azpurviewdefaultaccount
#>
function Get-AzPurviewDefaultAccount {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.Purview.Models.Api20201201Preview.IDefaultAccountPayload])]
...
process {
    try {
        Az.Purview.internal\Get-AzPurviewDefaultAccount @PSBoundParameters
    } catch {
        throw
    }
}
